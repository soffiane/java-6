...
class MaFenetreChap14ExDial extends JFrame implements ActionListener {
...
class Dialogue extends JDialog implements ActionListener {
    public Dialogue(JFrame parent) {
        ...
        /* choix couleur */
        comboCoulFond = new JComboBox(MaFenetreChap14ExDial.nomCouleurs);
...
class PaneauDessin extends JPanel {
    ...
    public void setCouleur(String c) {
        for (int i = 0; i < MaFenetreChap14ExDial.nomCouleurs.length; i++)
            if (c == MaFenetreChap14ExDial.nomCouleurs[i]) setBackground(MaFenetreChap14ExDial.couleurs[i]);
        nomCouleur = c;
    }
    ...
    private String nomCouleur = MaFenetreChap14ExDial.nomCouleurs[0];
}
