...
class MaFenetreChap17TestGroupLayout extends JFrame {
    public static int NBOUTONS = 4;

    public MaFenetreChap17TestGroupLayout() {
...
class TestGroupLayout1 {
    public static void main(String args[]) {
        MaFenetreChap17TestGroupLayout fen = new MaFenetreChap17TestGroupLayout();
        fen.setVisible(true);
    }
}
