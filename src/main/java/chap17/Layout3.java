...
class MaFenetreChap17Layout3 extends JFrame implements ActionListener {
    public static int NBOUTONS = 8;

    public MaFenetreChap17Layout3() {
...
public class Layout3 {
    public static void main(String args[]) {
        MaFenetreChap17Layout3 fen = new MaFenetreChap17Layout3();
        fen.setVisible(true);
    }
}
