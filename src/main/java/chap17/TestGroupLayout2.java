...
class MaFenetreChap17TestGroupLayout2 extends JFrame {
    public static int NBOUTONS = 6;

    public MaFenetreChap17TestGroupLayout2() {
        ...
        // description premi�re colonne suivant les deux axes
        ...
        // description deuxi�me colonne suivant les deux axes
...
public class TestGroupLayout2 {
    public static void main(String args[]) {
        MaFenetreChap17TestGroupLayout2 fen = new MaFenetreChap17TestGroupLayout2();
        fen.setVisible(true);
    }
}
