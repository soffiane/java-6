...
class FenMenuChap15Menu1a extends JFrame implements ActionListener, MenuListener {
    public FenMenuChap15Menu1a() {
...
public class Menu1a {
    public static void main(String args[]) {
        FenMenuChap15Menu1a fen = new FenMenuChap15Menu1a();
        fen.setVisible(true);
    }
}
