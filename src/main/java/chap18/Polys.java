...
class MaFenetreChap18Polys extends JFrame {
    MaFenetreChap18Polys() {
        setTitle("Essais polygones et lignes brisees");
        setSize(400, 180);
        pan = new PaneauChap18Polys();
...
class PaneauChap18Polys extends JPanel {
...
public class Polys {
    public static void main(String args[]) {
        MaFenetreChap18Polys fen = new MaFenetreChap18Polys();
        fen.setVisible(true);
    }
}
