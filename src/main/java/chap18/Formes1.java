...
class MaFenetreChap18Formes extends JFrame {
    MaFenetreChap18Formes() {
...
class PaneauChap18Formes extends JPanel {
    public void paintComponent(Graphics g) {
        ...
        /* noeud papillon rose � bordure verte */
        int r = 60;
        int x[] = new int[4];
        int y[] = new int[4];
...
public class Formes1 {
    public static void main(String args[]) {
        MaFenetreChap18Formes fen = new MaFenetreChap18Formes();
        fen.setVisible(true);
    }
}
