...
public class ExMenuAc extends JApplet implements ActionListener {
    ...
    public void init() {
        ...
        pan = new PaneauChap19ExMenuAc();
        contenu.add(pan);
        pan.setBackground(Color.cyan);

        int nbCouleurs = nomCouleurs.length;
        /* creation des actions */
        actions = new ActionCouleurChap19ExMenuAc[nbCouleurs];
        for (int i = 0; i < nbCouleurs; i++) {
            actions[i] = new ActionCouleurChap19ExMenuAc(nomCouleurs[i], couleurs[i],
                    nomIcones[i], pan);
        }
    ...
    private ActionCouleurChap19ExMenuAc[] actions;
    private JToolBar barreCouleurs;
    private PaneauChap19ExMenuAc pan;
}

class PaneauChap19ExMenuAc extends JPanel {
...
class ActionCouleurChap19ExMenuAc extends AbstractAction {
    public ActionCouleurChap19ExMenuAc(String nom, Color couleur, String nomIcone, PaneauChap19ExMenuAc pan) {
    ...
    private PaneauChap19ExMenuAc pan;
    static ActionCouleurChap19ExMenuAc actionInactive;   // ne pas oublier static
}
