...
public class ModifsChamps {
    public static void main(String args[]) throws IllegalAccessException {
        PointModifChamps p1 = new PointModifChamps();
        PointModifChamps p2 = new PointModifChamps(5, 9);
        Class<?> c = p1.getClass();
...
class PointModifChamps {
    public PointModifChamps() {
        x = 0;
        y = 0;
    }

    public PointModifChamps(int x, int y) {
        this.x = x;
        this.y = y;
    }
